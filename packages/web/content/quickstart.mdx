...
Create a file in your project and paste this in exactly:
...
That's it. No neural network code. No hyperparameter tuning. No config files.
...
### Line 2 — `import { CartPoleEnv } from '@ignitionai/core'`
...
### Line 8 — `env.infer()` (commented out)
...
### Line 9 — `env.setSpeed(50)` (commented out)
